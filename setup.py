...
setup(
    ...
    scripts=[
        ...
        "paasta_tools/paastak8s/bin/paasta_secrets_sync.py",
        "paasta_tools/paastak8s/bin/paasta_cleanup_stale_nodes.py",
        "paasta_tools/paastak8s/bin/kubernetes_remove_evicted_pods.py",
