...
def restart_replica_by_name(
    ...
    Implementation note: In Kubernetes, restarting a replica is achieved by
    deleting the existing pod. Kubernetes will automatically create a
    ...
    # Implementation: restart replica by deleting the pod
