...
class KubernetesDeploymentConfig(LongRunningServiceConfig):
    ...
    def get_autoscaling_scaling_policy(
        self, max_replicas: int, autoscaling_params: AutoscalingParamsDict,
    ) -> Dict:
...
def update_kubernetes_secret_signature(
    kube_client: KubeClient, secret: str, service: str, secret_signature: str, namesapce: str = "paasta"
) -> None:
    service = sanitise_kubernetes_name(service)
    secret = sanitise_kubernetes_name(secret)
...
def create_kubernetes_secret_signature(
    kube_client: KubeClient, secret: str, service: str, secret_signature: str, namespace: str = "paasta"
) -> None:
    service = sanitise_kubernetes_name(service)
    secret = sanitise_kubernetes_name(secret)
