        ...
        "configurations": [
            {
                ...
                "subProcess": True,
                "args": ["-e", "py312-linux,docs,mypy,tests"],
            },
            {
                "name": "paasta cli",
                "cwd": "${workspaceFolder}",
                "python": "${workspaceFolder}/.tox/py312-linux/bin/python",
                "type": "debugpy",
                "request": "launch",
            ...
            },
            {
                ...
                # 3) Run client command, e.g. PAASTA_SYSTEM_CONFIG_DIR=./etc_paasta_for_development/  .tox/py312-linux/bin/python paasta_tools/cli/cli.py status --clusters norcal-devc --service katamari_test_service
                "name": "paasta API",
                "cwd": "${workspaceFolder}",
                "python": "${workspaceFolder}/.tox/py312-linux/bin/python",
                "type": "debugpy",
