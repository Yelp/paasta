...
def make_app(global_config=None):
    ...
    config.add_route('pause_service_autoscaler.post', '/v1/pauseServiceAutoscaler', request_method="POST")
    config.add_route('pause_service_autoscaler.get', '/v1/pauseServiceAutoscaler', request_method="GET")
