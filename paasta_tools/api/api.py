...
def make_app():
    ...
    config.add_route('service.autoscaler.get', '/v1/services/{service}/{instance}/autoscaler')
    config.add_route('service.autoscaler.post', '/v1/services/{service}/{instance}/autoscaler/{desired_instances}')
