...
class PaastaServiceConfigLoader():
    ...
    def instances(self, cluster: str, instance_type_class: Type[utils.InstanceConfig_T]) -> Iterable[str]:
    ...
    def instance_configs(
        self,
        cluster: str,
        instance_type_class: Type[utils.InstanceConfig_T],
    ) -> Iterable[utils.InstanceConfig_T]:
    ...
    def _framework_config_filename(self, cluster: str, instance_type_class: Type[utils.InstanceConfig_T]):
        return f"{instance_type_class.config_filename_prefix}-{cluster}"

    def _refresh_framework_config(self, cluster: str, instance_type_class: Type[utils.InstanceConfig_T]):
    ...
    def _create_service_config(
        ...
        config_class: Type[utils.InstanceConfig_T],
    ) -> utils.InstanceConfig_T:
