...
class MarathonDashboardItem:
    ...
    """
    openapi_types = {"instance": "str", "service": "str", "shard_url": "str"}
    ...
    def __init__(
        self, instance=None, service=None, shard_url=None, local_vars_configuration=None
    ):  # noqa: E501
