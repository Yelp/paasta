...
import paasta_tools.paastaapi.models
from paasta_tools.paastaapi import rest
from paasta_tools.paastaapi.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(paasta_tools.paastaapi.models, klass)
