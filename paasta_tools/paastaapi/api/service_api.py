    ...
    def __init__(self, api_client=None):
        ...
        def __get_deployment_info(
            ...
            **kwargs
            ...
            Args:
                service (str): Service name
                deploy_group (str): Deploy group name
        ...
        def __get_flink_cluster_job_checkpoints(
            self,
            service,
            instance,
            job_id,
            **kwargs
            ...
            """Get checkpoint status of a flink job  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_flink_cluster_job_checkpoints(service, instance, job_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_flink_cluster_job_checkpoints = Endpoint(
            settings={
                'response_type': (FlinkCheckpointStatus,),
                'auth': [],
                'endpoint_path': '/flink/{service}/{instance}/jobs/{job_id}/checkpoints',
                'operation_id': 'get_flink_cluster_job_checkpoints',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_flink_cluster_job_checkpoints
        )
        ...
        def __instance_replica_restart(
            self,
            service,
            instance,
            replica_name,
            **kwargs
            ...
            """Restart a specific replica for service_name.instance_name  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.instance_replica_restart(service, instance, replica_name, async_req=True)
            >>> result = thread.get()
        ...
        self.instance_replica_restart = Endpoint(
            ...
            api_client=api_client,
            callable=__instance_replica_restart
        )
