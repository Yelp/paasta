...
class DeploymentInfo(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, docker_image, git_sha, image_url, *args, **kwargs):  # noqa: E501
        """DeploymentInfo - a model defined in OpenAPI

        Args:
            docker_image (str): Docker image name and tag (without registry)
            git_sha (str): Git SHA of the deployment
            image_url (str): Full container registry URL with image name and tag
