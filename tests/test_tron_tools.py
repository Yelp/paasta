...
class TestTronTools:
    ...
    def test_format_tron_action_dict_spark(
        ...
        # Expected spark config passed as JSON string via --conf spark.yelp.scs.conf=
        # NOTE: Don't change the formatting of this string, as the test relies on exact matching
        expected_scs_conf = """'{
    ...
    "aws_account_id": null
        ...
        expected = {
            ...
            f"--conf scs_conf={expected_scs_conf} "
