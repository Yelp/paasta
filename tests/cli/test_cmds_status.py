...
class TestPrintFlinkStatus:
    ...
    def test_output_stopping_jobmanager(
        ...
        expected_output = [
            ...
            f"    Flink Monitoring:",
            f"      Job Metrics: https://grafana.yelpcorp.com/d/flink-metrics/flink-job-metrics?orgId=1&var-datasource=Prometheus-flink&var-region=uswest2-fake_cluster&var-service=fake_service&var-instance=fake_instance&var-job=All&from=now-24h&to=now",
            f"      Container Metrics: https://grafana.yelpcorp.com/d/flink-container-metrics/flink-container-metrics?orgId=1&var-datasource=Prometheus-flink&var-region=uswest2-fake_cluster&var-service=fake_service&var-instance=fake_instance&from=now-24h&to=now",
            f"      JVM Metrics: https://grafana.yelpcorp.com/d/flink-jvm-metrics/flink-jvm-metrics?orgId=1&var-datasource=Prometheus-flink&var-region=uswest2-fake_cluster&var-service=fake_service&var-instance=fake_instance&from=now-24h&to=now",
    ...
    def test_output_1_verbose(
        ...
        expected_output = _get_base_status_verbose_1(metadata) + [
            ...
            f"    Srv configs: https://sourcegraph.yelpcorp.com/sysgit/srv-configs/-/tree/ecosystem/fake_cluster/fake_service",
            f"    Flink Log Commands:",
            f"      Service:     paasta logs -a 1h -c pnw-fake_cluster -s fake_service -i fake_instance",
            f"      Taskmanager: paasta logs -a 1h -c pnw-fake_cluster -s fake_service -i fake_instance.TASKMANAGER",
            f"      Jobmanager:  paasta logs -a 1h -c pnw-fake_cluster -s fake_service -i fake_instance.JOBMANAGER",
            f"      Supervisor:  paasta logs -a 1h -c pnw-fake_cluster -s fake_service -i fake_instance.SUPERVISOR",
            f"    Flink Monitoring:",
            f"      Job Metrics: https://grafana.yelpcorp.com/d/flink-metrics/flink-job-metrics?orgId=1&var-datasource=Prometheus-flink&var-region=uswest2-fake_cluster&var-service=fake_service&var-instance=fake_instance&var-job=All&from=now-24h&to=now",
            f"      Container Metrics: https://grafana.yelpcorp.com/d/flink-container-metrics/flink-container-metrics?orgId=1&var-datasource=Prometheus-flink&var-region=uswest2-fake_cluster&var-service=fake_service&var-instance=fake_instance&from=now-24h&to=now",
            f"      JVM Metrics: https://grafana.yelpcorp.com/d/flink-jvm-metrics/flink-jvm-metrics?orgId=1&var-datasource=Prometheus-flink&var-region=uswest2-fake_cluster&var-service=fake_service&var-instance=fake_instance&from=now-24h&to=now",
