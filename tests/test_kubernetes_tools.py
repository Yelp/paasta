...
class TestKubernetesDeploymentConfig:
    ...
    def test_get_pod_template_spec(
        ...
        if autoscaling_metric_provider:
            ...
            if autoscaling_metric_provider != MetricsProviderType.Uwsgi:
                expected_labels[
    ...
    def test_routable_ip(
        ...
        def mock_should_use_metrics_provider_fn(p: MetricsProviderType) -> bool:
            if p == MetricsProviderType.Uwsgi:
                return should_use_uwsgi_provider
            elif p == MetricsProviderType.Gunicorn:
                    ...
                    V2beta2MetricSpec(
                        ...
                        object=V2beta2ObjectMetricSource(
                            metric=V2beta2MetricIdentifier(
                                name=f"service-instance-{metrics_provider.value}-prom"
                            ),
