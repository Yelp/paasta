...
def test_main_yaml_config(
    ...
    with patch(
        "paasta_tools.generate_authenticating_services.parse_args"
    ) as mock_parse_args, patch("paasta_tools.utils.datetime") as mock_datetime, patch(
        "paasta_tools.utils.socket"
    ) as mock_socket:
