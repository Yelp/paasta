...
from paasta_tools.kubernetes_scripts.paasta_secrets_sync import main
from paasta_tools.kubernetes_scripts.paasta_secrets_sync import parse_args
from paasta_tools.kubernetes_scripts.paasta_secrets_sync import sync_all_secrets
from paasta_tools.kubernetes_scripts.paasta_secrets_sync import sync_secrets


def test_parse_args():
    with mock.patch(
        'paasta_tools.kubernetes_scripts.paasta_secrets_sync.argparse.ArgumentParser', autospec=True,
    ):
        assert parse_args()
...
def test_main():
    with mock.patch(
        'paasta_tools.kubernetes_scripts.paasta_secrets_sync.parse_args', autospec=True,
    ), mock.patch(
        'paasta_tools.kubernetes_scripts.paasta_secrets_sync.load_system_paasta_config', autospec=True,
    ), mock.patch(
        'paasta_tools.kubernetes_scripts.paasta_secrets_sync.KubeClient', autospec=True,
    ), mock.patch(
        'paasta_tools.kubernetes_scripts.paasta_secrets_sync.sync_all_secrets', autospec=True,
...
def test_sync_all_secrets():
    with mock.patch(
        'paasta_tools.kubernetes_scripts.paasta_secrets_sync.sync_secrets', autospec=True,
...
def test_sync_secrets():
    with mock.patch(
        'paasta_tools.kubernetes_scripts.paasta_secrets_sync.get_secret_provider', autospec=True,
    ) as mock_get_secret_provider, mock.patch(
        'paasta_tools.kubernetes_scripts.paasta_secrets_sync.os.scandir', autospec=True,
    ) as mock_scandir, mock.patch(
        'paasta_tools.kubernetes_scripts.paasta_secrets_sync.open', create=True, autospec=False,
    ), mock.patch(
        'paasta_tools.kubernetes_scripts.paasta_secrets_sync.get_kubernetes_secret_signature', autospec=True,
    ) as mock_get_kubernetes_secret_signature, mock.patch(
        'paasta_tools.kubernetes_scripts.paasta_secrets_sync.create_secret', autospec=True,
    ) as mock_create_secret, mock.patch(
        'paasta_tools.kubernetes_scripts.paasta_secrets_sync.create_kubernetes_secret_signature', autospec=True,
    ) as mock_create_kubernetes_secret_signature, mock.patch(
        'paasta_tools.kubernetes_scripts.paasta_secrets_sync.update_secret', autospec=True,
    ) as mock_update_secret, mock.patch(
        'paasta_tools.kubernetes_scripts.paasta_secrets_sync.update_kubernetes_secret_signature', autospec=True,
    ) as mock_update_kubernetes_secret_signature, mock.patch(
        'paasta_tools.kubernetes_scripts.paasta_secrets_sync.json.load', autospec=True,
    ):
