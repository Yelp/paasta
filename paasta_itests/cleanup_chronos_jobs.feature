Feature: cleanup_chronos_jobs removes chronos jobs no longer in the config
 ...
 Scenario: Cleanup chronos jobs removes jobs
    Given a working paasta cluster
     ...
     When I launch 3 "known" chronos jobs with service "myservice" with chronos instance "UNUSED" and differing tags
      And I launch 1 "unknown" chronos jobs with service "oldservice" with chronos instance "foo" and differing tags
     ...
     Then cleanup_chronos_jobs exits with return code "0" and the correct output
      ...
      And the "known" chronos jobs are in the job list
      And the "unknown" chronos jobs are not in the job list
