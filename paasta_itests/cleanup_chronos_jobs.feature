Feature: cleanup_chronos_jobs removes chronos jobs no longer in the config
 ...
 Scenario: Cleanup chronos jobs removes jobs
    Given a working paasta cluster
      And I have yelpsoa-configs for service "myservice", chronos instance "UNUSED" and cmd "echo hello"
     When I launch 3 configured jobs with service "myservice", chronos instance "UNUSED" and differing tags
      And I launch 1 unconfigured jobs with service "oldservice", chronos instance "foo" and differing tags
