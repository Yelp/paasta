...
def test_report_status_calls_execute_paasta_serviceinit_on_remote_master(
    ...
    mock_execute_paasta_serviceinit_on_remote_master.assert_any_call('a_cluster', service_name, 'a_instance')
    mock_execute_paasta_serviceinit_on_remote_master.assert_any_call('b_cluster', service_name, 'b_instance')
