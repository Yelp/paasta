...
class MarathonClient:
    ...
    timeout = ...  # type: Any
    auth_token = ...  # type: Any
    def __init__(self, servers, username: Optional[Any] = ..., password: Optional[Any] = ..., timeout: int = ..., session: Optional[Any] = ..., auth_token: Optional[Any] = ..., verify: bool = ..., sse_session: Optional[Any] = ...) -> None: ...
    def list_endpoints(self): ...
    def create_app(self, app_id, app): ...
    def list_apps(self, cmd: Optional[Any] = ..., embed_tasks: bool = ..., embed_counts: bool = ..., embed_deployments: bool = ..., embed_readiness: bool = ..., embed_last_task_failure: bool = ..., embed_failures: bool = ..., embed_task_stats: bool = ..., app_id: Optional[Any] = ..., label: Optional[Any] = ..., **kwargs): ...
