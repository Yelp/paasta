...
Deployment
----------
A yelpsoa-configs master runs ``generate_all_deployments`` frequently. The generated
``deployments.json`` appears in ``/nail/etc/services/service_name`` throughout the cluster.
