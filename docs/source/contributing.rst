...
Python 3.12 and virtualenv are required for running the unit tests. You can simply run
...
Python 3.12, virtualenv, and Docker are required to run the integration test suite.
